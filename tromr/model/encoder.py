...
def get_encoder(args):
    backbone_layers = list(args.model.backbone_layers)
    backbone = ResNetV2(
        layers=backbone_layers, num_classes=0, global_pool='', in_chans=args.model.channels,
    ...
    print("Args received by get_encoder:", args)
